...
?>
<!-- ARCHIVO DE LA INSERCCION DE LA TARJETA, VISTA -->
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  ...
  <style>
    ...
    .footer {
      ...
      color: white;
      text-align: center;}
    .cell.example.example1{
    margin-top: -10%;}
  </style>

</head>
<body style="background-color:black;">
<h1 style="color:white; text-align:center; font-family: Helvetica; margin-top:5%;"><u>TRAMITAR PEDIDO</u></h1>
<div class="modal" style="margin-top:-5%;">
    <div class="modal__container">
      <div class="modal__featured">
        <a href="/shopNoe/public/cesta">
        <button type="button" class="button--transparent button--close">
          <svg class="nc-icon glyph"   x="0px" y="0px" width="32px" height="32px" viewBox="0 0 32 32">
        ...
        <img src="../../imatges/logo/logo_small_icon_only_inverted.png" class="modal__product" style="margin-top:30%; margin-left:-5%;" />
      </div>
      <div class="modal__content">
        <h2 style="color:black; text-align:center;">Sus datos de pago</h2>
        <div class="top">
          <br></br>
          <label style="color:black;">IMPORTE TOTAL ES DE <?=$value?> €  </label>
        </div>
        <br><br><br><br>
        <div class="cell example example1" id="example-1">
          <form action="CreateCharge.php?value=<?=$value?>&usuarioId=<?=$usuarioId?>" method="post" id="payment-form" style="margin:4%;">
            <div class="form-row">
              <label for="card-element">
                <h2 style="color:black;">NÚMERO DE TARJETA</h2><br>
              </label>
              <div id="card-element">
              </div>
...
var stripe = Stripe('pk_test_51Ir2M4FV4okoRfYF8CZeevTgfNJxgL38PyfZZvg0HAd8pkS1jqq57yCcleeUbUxd7VmS00vHVOcuPIVHQOnkgPNd00uM3iRxlk');
